...
class Admin extends Master {
	...
	private $default_url="berita/admin/";
	private $default_view="berita/admin/";
	...
	private function global_set($data){
		$data=array(
			...
			'url'=>$data['url'],
			'ikon'=>"fa fa-tags",
			'view'=>"views/berita/admin/index.php",
			'detail'=>false,
			'edit'=>true,
			'delete'=>true,
		);
	...
	public function add(){
		$global_set=array(
			'submenu'=>false,
			'headline'=>'berita',
			'url'=>'berita/admin/', //AKAN DIREDIRECT KE INDEX
		);
		$global=$this->global_set($global_set);
		$kategori=array(
			'tabel'=>'kategori',
