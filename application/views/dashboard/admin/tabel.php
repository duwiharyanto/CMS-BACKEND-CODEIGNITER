	...
	<div class="col-sm-3">
		<div class="box box-primary">
			<div class="box-body box-profile">
			  ...
			  <a href="<?= site_url('user/admin')?>" class="btn btn-primary btn-block"><b>Edit</b></a>
			</div>
		</div>		
	</div>
	<div class="col-sm-9">
		                	...
		                	<?php $i=1;foreach ($data as $row):?>
			                	<tr>
			                		...
			                		<td class="text-center">
			                			<a href="<?= base_url('berita/admin')?>"  class="btn btn-flat btn-xs btn-success <?= $global->detail!=true ? 'disabled':'' ?>"><span class="fa fa-eye"></span></a>
			                		</td>
			                	</tr>	                	
		                	<?php $i++;endforeach;?>
		                </tbody>            		
		                ...
		                <tbody>
		                	<?php $i=1;foreach ($media as $row):?>
			                	<tr>
			                		...
			                		<td class="text-center">
			                			<a href="<?= base_url('media/admin')?>" class="btn btn-flat btn-xs btn-success <?= $global->detail!=true ? 'disabled':'' ?>"><span class="fa fa-eye"></span></a>
			                		</td>
			                	</tr>	                	
		                	<?php $i++;endforeach;?>
		                </tbody>            		
