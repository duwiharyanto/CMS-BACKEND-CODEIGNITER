					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Id</label>
								<input type="text" name="id" readonly class="form-control" value="<?= $data->media_id?>">
							</div>
							<div class="form-group">
								<label>Tanggal Tersimpan</label>
								<input type="text" name="media_tersimpan" class="form-control" value="<?= date('d-m-Y',strtotime($data->media_tersimpan))?>" readonly="readonly">
							</div>							
							<div class="form-group">
								<label>Nama</label>
								<input type="text" name="media_nama" class="text-capitalize form-control" value="<?= $data->media_nama?>">
							</div>																																											 
						</div>
					</div>
					<div class="row">
