    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <a href="#" style="pointer-events:none"><span class="fa fa-clock-o"></span><?= date('d-m-Y')?></a>
          </li>
          <li class="dropdown user user-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?= $this->session->userdata('user_email')?>
                  <small><?php echo "Terdaftar : " .date('d-m-y',strtotime($this->session->userdata('user_terdaftar')))?></small>
                </p>
              </li>
              <!-- Menu Footer-->
